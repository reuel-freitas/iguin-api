...
class TiposDeImoveisDisponiveisController extends Controller
{
    public  $chave = '';
    ...
    public function filtros($codigoTipo, $var2)
    {
        ...
        $numeroRegistros = '"numeroRegistros":"6",';
        $codigoCidade = '"codigoCidade": "1",';

        $params = "$finalidade $numeroPagina $numeroRegistros $codigoCidade";
    ...
    public function index($codigoTipo = 0, $var2 = 0)
    {
        ...
        $url = 'https://api.imoview.com.br/Imovel/RetornarTiposImoveisDisponiveis?parametros={' . $params . '}';
